...
public class BrowseNodeLookup 
    ...
    private static final long serialVersionUID = 5496304167984833180L;
    private String marketplaceDomain;
    private String aWSAccessKeyId;
    private String associateTag;
    private String validate;
    private String xMLEscaping;
    private BrowseNodeLookupRequest shared;
    private List<BrowseNodeLookupRequest> request;
    /** GETTER
     ...
     */
    @JsonSetter("Request")
    public void setRequest (List<BrowseNodeLookupRequest> value) { 
        this.request = value;
